...
1. This is a work in progress book designed to built using the [gitbook tool chain](https://github.com/nholuongut/gitbook).

1. It is hosted on [github](https://github.com/nholuongut/kerberos-and-hadoop).
